...
class ShippingAddress(models.Model):
    ...
    def __str__(self):
        return f"ShippingAddress object: {self.full_name}"
    ...
    def create_default_shipping_address(cls, user):
        default_shipping_address = {"user": user, "full_name": "Noname", "email": "email@gmail.com",
                                    "street_address": "fill address", "apartment_address": "apartment", "country": ""}
...
class Order(models.Model):
    ...
    class Meta:
        ...
        constraints = [models.CheckConstraint(check=models.Q(total_price__gte=0), name='amount_gte_0')]

    def __str__(self):
        return f"Order object: {self.id}"

    def get_absolute_url(self):
        return reverse('payment:order_detail', args=(self.id,))
